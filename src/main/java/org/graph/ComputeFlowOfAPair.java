                ...
                for (String s : node[0].split(",")) {
                    ...
                    for (String network : networkType) {
                        ...
                        for (int j = 0; j < 2; j++) {
                            temp += j;
                            if (j == 1) {
                                weight = Integer.parseInt(splits1[temp]);
                                if (Integer.parseInt(splits1[temp]) != 0)
                    ...
                    double sourceInfluence = scoreOfvBeta
                            * weights.get(flowType);
                    ...
                    for (String network : networkType) {
                        ...
                        if (!flowType.equals(network)) {
                            String conditionalProbKey = sourceNetworkIndex
                                    + "_" + networkIndex;
                    ...
                    if (edgeTypes > 1) {
                        ...
                        otherNeighborsInfluence = scoreOfvBeta
                                * (otherNeighborsInfluence / (edgeTypes - 1));
                        totalInfluence = sourceInfluence
                                + otherNeighborsInfluence;
                    } else {
                        totalInfluence = sourceInfluence;
                    }
                    s += (":" + totalInfluence);
